...
import MyInsultsScreen from './screens/MyInsultsScreen';
  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        <Stack.Screen name="MyInsultsScreen" component={MyInsultsScreen} options={{ title: 'Mes Insultes', headerBackVisible: false }}/>
      </Stack.Navigator>
    </NavigationContainer>
  );
}
